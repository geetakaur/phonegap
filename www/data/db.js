...
(function() {
    ...
    var endpointSelector = new DevExpress.EndpointSelector(SmartLiberate_v2.config.endpoints);
    var serviceConfig = $.extend(true, {}, SmartLiberate_v2.config.services, {
        db: {
    ...
    SmartLiberate_v2.db = new DevExpress.data.ODataContext(serviceConfig.db);
